...
const isIndexingLatencyError = (err: unknown): boolean => {
  ...
  return (name === 'GraphResponseError' || name?.endsWith('GraphResponseError') === true)
...
): Promise<{ ok: true; response: Awaited<ReturnType<GraphClient['getPreviewContent']>> } | { ok: false }> {
